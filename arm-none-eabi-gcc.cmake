...
set(CMAKE_COMMON_FLAGS  "${MCPU} ${MFLOAT_ABI} -${ARM_ISA} -D${TARGET} -DUSE_HAL_DRIVER -${OPTIMISATION} ${DEBUG} ${WARN_FLAGS} -ffunction-sections -fdata-sections -fstack-usage --specs=nano.specs")
if (DEBUG)
    set(CMAKE_COMMON_FLAGS "${CMAKE_COMMON_FLAGS} -DDEBUG")
else()
set(CMAKE_COMMON_FLAGS "${CMAKE_COMMON_FLAGS} -DGBEDUG_FORCE")
endif()
