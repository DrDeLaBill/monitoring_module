...
set(CMAKE_COMMON_FLAGS  "${MCPU} ${MFLOAT_ABI} -${ARM_ISA} -D${TARGET} -DUSE_HAL_DRIVER -${OPTIMISATION} ${DEBUG} ${WARN_FLAGS} -ffunction-sections -fdata-sections -fstack-usage -fcyclomatic-complexity --specs=nano.specs")
if (DEBUG)
